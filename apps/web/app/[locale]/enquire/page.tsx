    ...
    <main id="main" className="flex-1 bg-midnight px-4 py-16 text-ink-inverse sm:px-6 sm:py-20">
      <div className="mx-auto grid max-w-5xl gap-14 lg:grid-cols-[1fr_1.3fr]">
        <div>
          ...
          */}
          <p className="mt-8 border-t border-white/12 pt-6 text-sm leading-relaxed text-ink-inverse/55">
            {isSettled(hours)
              ? hours.value
              : "We have not published response times yet, because we will not promise one we cannot keep. You will hear from a person."}
          </p>
          <p className="mt-4 text-sm leading-relaxed text-ink-inverse/55">
