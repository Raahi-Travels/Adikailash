    ...
    <main id="main" className="flex-1 register-light px-4 py-16 text-tone-strong sm:px-6 sm:py-20">
      <div className="mx-auto grid max-w-5xl gap-14 lg:grid-cols-[1fr_1.4fr]">
        <div>
          ...
          <p className="mt-5 max-w-[44ch] text-[15px] leading-relaxed text-tone-body">
          ...
          <p className="mt-6 max-w-[44ch] text-sm leading-relaxed text-tone-muted">
        ...
        {token ? (
          ...
          <div className="rounded-lg bg-ink/[0.03] px-6 py-7 ring-1 ring-tone-line">
